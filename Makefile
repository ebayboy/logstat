...
am__objects_1 = select.lo
am__objects_2 = poll.lo
#am__objects_3 = devpoll.lo
#am__objects_4 = kqueue.lo
#am__objects_5 = epoll.lo
#am__objects_6 = evport.lo
am__objects_7 = signal.lo
am__objects_8 = $(am__objects_1) $(am__objects_2) \
	$(am__objects_3) $(am__objects_4) \
	$(am__objects_5) $(am__objects_6) \
	$(am__objects_7)
#am__objects_8 = win32select.lo evthread_win32.lo \
#	buffer_iocp.lo event_iocp.lo \
#	bufferevent_async.lo $(am__objects_1) \
...
#am_libevent_openssl_la_OBJECTS = bufferevent_openssl.lo
...
ACLOCAL = ${SHELL} /cygdrive/d/github.com/logstat/src/libs/libevent/missing --run aclocal-1.12
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} /cygdrive/d/github.com/logstat/src/libs/libevent/missing --run autoconf
AUTOHEADER = ${SHELL} /cygdrive/d/github.com/logstat/src/libs/libevent/missing --run autoheader
AUTOMAKE = ${SHELL} /cygdrive/d/github.com/logstat/src/libs/libevent/missing --run automake-1.12
AWK = gawk
CC = gcc
...
LIBTOOL_DEPS = ./src/libs/libevent/ltmain.sh
LIPO = 
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /cygdrive/d/github.com/logstat/src/libs/libevent/missing --run makeinfo
MANIFEST_TOOL = :
...
ZLIB_LIBS = 
abs_builddir = /cygdrive/d/github.com/logstat
abs_srcdir = /cygdrive/d/github.com/logstat/./src/libs/libevent
abs_top_builddir = /cygdrive/d/github.com/logstat
abs_top_srcdir = /cygdrive/d/github.com/logstat/./src/libs/libevent
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
acx_pthread_config = 
...
install_sh = ${SHELL} /cygdrive/d/github.com/logstat/src/libs/libevent/install-sh
...
srcdir = ./src/libs/libevent
sysconfdir = ${prefix}/etc
target_alias = 
top_build_prefix = 
top_builddir = .
top_srcdir = ./src/libs/libevent
...
SYS_SRC = $(am__append_5) $(am__append_6) \
	...
	$(am__append_11)
#SYS_SRC = win32select.c evthread_win32.c \
#	buffer_iocp.c event_iocp.c \
#	bufferevent_async.c $(am__append_5) \
...
include $(DEPDIR)/epoll_sub.Plo
include ./$(DEPDIR)/buffer.Plo
include ./$(DEPDIR)/buffer_iocp.Plo
include ./$(DEPDIR)/bufferevent.Plo
include ./$(DEPDIR)/bufferevent_async.Plo
include ./$(DEPDIR)/bufferevent_filter.Plo
include ./$(DEPDIR)/bufferevent_openssl.Plo
include ./$(DEPDIR)/bufferevent_pair.Plo
include ./$(DEPDIR)/bufferevent_ratelim.Plo
include ./$(DEPDIR)/bufferevent_sock.Plo
include ./$(DEPDIR)/devpoll.Plo
include ./$(DEPDIR)/epoll.Plo
include ./$(DEPDIR)/evdns.Plo
include ./$(DEPDIR)/event.Plo
include ./$(DEPDIR)/event_iocp.Plo
include ./$(DEPDIR)/event_tagging.Plo
include ./$(DEPDIR)/evmap.Plo
include ./$(DEPDIR)/evport.Plo
include ./$(DEPDIR)/evrpc.Plo
include ./$(DEPDIR)/evthread.Plo
include ./$(DEPDIR)/evthread_pthread.Plo
include ./$(DEPDIR)/evthread_win32.Plo
include ./$(DEPDIR)/evutil.Plo
include ./$(DEPDIR)/evutil_rand.Plo
include ./$(DEPDIR)/http.Plo
include ./$(DEPDIR)/kqueue.Plo
include ./$(DEPDIR)/listener.Plo
...
include ./$(DEPDIR)/win32select.Plo
